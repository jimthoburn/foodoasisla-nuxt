...
import TestLocationListThree from '~/components/TestLocationListThree.vue'
...
export default {
  ...
  components: {
    LocationMap, TestLocationListThree, LocationListNav, LocationDetails
  },
