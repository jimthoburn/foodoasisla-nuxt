...
import TestLocationListFour from '~/components/TestLocationListFour.vue'
...
export default {
  ...
  components: {
    LocationMap, TestLocationListFour, LocationListNav, LocationDetails
  },
