...
import TestLocationListTwo from '~/components/TestLocationListTwo.vue'
...
export default {
  ...
  components: {
    LocationMap, TestLocationListTwo, LocationListNav, LocationDetails
  },
